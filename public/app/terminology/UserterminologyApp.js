...
var app = angular.module("UserterminologyApp", ['ui.router']);
...
app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        .state('list1', {
            url: "/list1",
            templateUrl: "assets/app/terminology/terminologyword/list1.html",
            controller: "ListCtrl",
            resolve : {
        ...
        .state('add', {
            url: "/add",
            templateUrl: "assets/app/terminology/terminologyword/form1.html",
            controller : "FormCtrl",
            resolve : {
